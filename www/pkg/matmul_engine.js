/* @ts-self-types="./matmul_engine.d.ts" */
 ...
 * @returns {boolean}
 */
export function init_model(bytes) {
 ...
 * @param {Uint8Array} token_ids
 * @returns {Float32Array}
 */
export function predict(token_ids) {
    const ptr0 = passArray8ToWasm0(token_ids, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('matmul_engine_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
